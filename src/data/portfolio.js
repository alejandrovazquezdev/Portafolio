...
export const currentActivity = {
  ...
  description: "Actualmente participando en el Gemini 3 Hackathon organizado por Kaggle. Competencia enfocada en desarrollo de soluciones innovadoras con tecnologías de IA y machine learning.",
  status: "En progreso",
  platform: "Kaggle",
...
export const featuredProjects = [
  {
    ...
    description: "Motor de sincronización y consulta cruzada entre bases de datos Firebird y PostgreSQL. Permite realizar operaciones JOIN complejas entre diferentes motores de base de datos, optimizando la migración y el análisis de datos en sistemas legados.",
